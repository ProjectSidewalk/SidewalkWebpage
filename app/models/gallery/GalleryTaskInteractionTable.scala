...
class GalleryTaskInteractionTable(tag: slick.lifted.Tag) extends Table[GalleryTaskInteraction](tag, Play.configuration.getString("db-schema"), "gallery_task_interaction") {
