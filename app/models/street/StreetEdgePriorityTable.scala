...
//    * @return
//    */
//  def updateAllStreetEdgePriorities(rankParameterGeneratorList: List[()=>List[StreetEdgePriorityParameter]], weightVector: List[Double]) = {
//
...
//    * @return
//    */
//  def selectGoodBadUserCompletionCountPriority: List[StreetEdgePriorityParameter] = {
//    /********** Quality of Users **********/
//
