...
case class ValidationTaskEnvironment(
    validationTaskEnvironmentId: Int,
...
class ValidationTaskEnvironmentTableDef(tag: Tag)
    extends Table[ValidationTaskEnvironment](tag, "validation_task_environment") {
...
class ValidationTaskEnvironmentTable @Inject() (protected val dbConfigProvider: DatabaseConfigProvider)
    extends ValidationTaskEnvironmentTableRepository
