...
class ValidationTaskEnvironmentTable(tag: Tag) extends Table[ValidationTaskEnvironment](tag, Play.configuration.getString("db-schema"), "validation_task_environment") {
