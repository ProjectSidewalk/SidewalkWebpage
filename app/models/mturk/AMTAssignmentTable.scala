...
case class AMTAssignment(
    amtAssignmentId: Int,
    hitId: String,
    assignmentId: String,
    assignmentStart: OffsetDateTime,
    assignmentEnd: OffsetDateTime,
    workerId: String,
...
@Singleton
class AMTAssignmentTable @Inject() (protected val dbConfigProvider: DatabaseConfigProvider)
    extends AMTAssignmentTableRepository
