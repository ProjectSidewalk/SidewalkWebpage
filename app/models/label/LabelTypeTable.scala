...
object LabelTypeTable {
  ...
  val validationLabelTypeIds: Seq[Int] = Seq(1, 2, 3, 4, 7, 9, 10)
  val validationLabelTypes: Seq[String] = validationLabelTypeIds.map(labelTypeIdToLabelType)
  def primaryLabelTypes: Set[String] = Set("CurbRamp", "NoCurbRamp", "Obstacle", "SurfaceProblem", "NoSidewalk", "Crosswalk", "Signal")
}
