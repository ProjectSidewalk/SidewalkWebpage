...
class GlobalAttributeUserAttributeTable(tag: Tag) extends Table[GlobalAttributeUserAttribute](tag, Play.configuration.getString("db-schema"), "global_attribute_user_attribute") {
