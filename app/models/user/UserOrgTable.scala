...
@Singleton
class UserOrgTable @Inject()(protected val dbConfigProvider: DatabaseConfigProvider) extends UserOrgTableRepository with HasDatabaseConfigProvider[MyPostgresDriver] {
  import driver.api._
