...
class UserSurveyOptionSubmissionTable(tag: Tag) extends Table[UserSurveyOptionSubmission](tag, Play.configuration.getString("db-schema"), "user_survey_option_submission") {
