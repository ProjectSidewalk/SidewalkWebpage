...
class UserStatTable @Inject()(protected val dbConfigProvider: DatabaseConfigProvider,
  ...
  /**
   * Gets user statistics with optional filtering applied at the database query level.
   * This is more efficient than filtering after retrieving all data from the database.
   *
