...
@Singleton
class SurveyQuestionTable @Inject()(protected val dbConfigProvider: DatabaseConfigProvider) extends SurveyQuestionTableRepository with HasDatabaseConfigProvider[MyPostgresDriver] {
  import driver.api._
