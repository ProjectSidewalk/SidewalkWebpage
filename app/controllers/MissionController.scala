...
class MissionController @Inject() (cc: ControllerComponents,
  ...
  /**
    ...
    */
//  def getMissionsInCurrentRegion() = silhouette.SecuredAction.async { implicit request =>
...
//  }
  ...
  /**
    ...
    */
//  def getTotalRewardEarned() = silhouette.SecuredAction.async { implicit request =>
//    request.identity match {
