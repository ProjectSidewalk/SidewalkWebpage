...
object TaskSubmissionFormats {
  ...
  case class GSVPanoramaSubmission(gsvPanoramaId: String, imageDate: String, imageWidth: Option[Int], imageHeight: Option[Int], tileWidth: Option[Int], tileHeight: Option[Int], lat: Option[Float], lng: Option[Float], photographerHeading: Option[Float], photographerPitch: Option[Float], links: Seq[GSVLinkSubmission], copyright: String)
  ...
  implicit val gsvPanoramaSubmissionReads: Reads[GSVPanoramaSubmission] = (
    (JsPath \ "panorama_id").read[String] and
      ...
      (JsPath \ "lat").readNullable[Float] and
      (JsPath \ "lng").readNullable[Float] and
      (JsPath \ "photographer_heading").readNullable[Float] and
      (JsPath \ "photographer_pitch").readNullable[Float] and
