...
object TaskSubmissionFormats {
  ...
  case class TaskSubmission(streetEdgeId: Int, taskStart: String, auditTaskId: Option[Int], completed: Option[Boolean], currentLat: Float, currentLng: Float, startEndpointReversed: Boolean)
  ...
  implicit val auditTaskReads: Reads[TaskSubmission] = (
    (JsPath \ "street_edge_id").read[Int] and
      ...
      (JsPath \ "start_endpoint_reversed").read[Boolean]
