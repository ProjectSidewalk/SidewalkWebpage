...
# import, so a new test file runs in both by default instead of silently in neither. COVERAGE_OMIT is explained in
# pyproject.toml.
pytest-args-app   = test/python --ignore=test/python/test_check_streets_for_imagery.py \
                    --ignore=test/python/test_build_city_streets.py
