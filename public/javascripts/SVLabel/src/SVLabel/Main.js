...
function Main (params) {
    ...
    function _init (params) {
        ...
        svl.modalMissionComplete = new ModalMissionComplete(svl.missionContainer, svl.taskContainer, modalMissionCompleteMap, modalMissionCompleteProgressBar, svl.ui.modalMissionComplete, svl.modalModel);
