/**
 *
 * An object that contains all the information to render a label onto a pano. Used in the GalleryPanorama.renderLabel().
 *
 ...
 * @param {Number} heading The heading of the pano when the label was added in audit.
 * @param {Number} pitch The pitch of the pano when the label was added in audit.
 * @param {Number} zoom The zoom of the pano when the label was added in audit.
