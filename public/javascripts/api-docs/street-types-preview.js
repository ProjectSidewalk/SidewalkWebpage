 ...
 * 
 * This script generates a preview table of OpenStreetMap street types
 * by fetching data directly from the Street Types API.
 * 
...
(function() {
  ...
  let config = {
    // TODO: update the BASE_URL to the production API URL in production
