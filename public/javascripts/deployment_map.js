 ...
 *
 * Creates an interactive MapBox map showing all Project Sidewalk deployment sites as clickable circles. Each circle
 * opens a popup with a link to explore that city.
 *
 * Dependencies:
...
/**
 * Initialize the deployment map with the provided MapBox API key. Sets up the MapBox map and loads city data.
 *
...
/**
 * Fetch cities data from the API. Handles API response and processes city data.
 */
...
/**
 * Add city markers to the map. Creates GeoJSON source and adds circle layers for each city.
 */
...
/**
 * Add hover effects to city circles. Changes circle appearance on mouse enter/leave.
 */
...
/**
 * Add click handlers for city circles. Opens popup with explore link when circle is clicked.
 */
