...
function MistakeCarousel(userId) {
    fetch(`/userapi/mistakes?userId=${userId}&n=7`).then((response) => {
        ...
        const labelTypesWithData = [];
        const labelTypesWithoutData = [];
        ...
        const mistakesSubheader = document.getElementById('mistakes-subheader-display');
        ...
        const mistakesHolder = document.getElementById('mistake-carousels-holder');
        for (const [typeIndex, labelType] of labelTypesWithData.entries()) {
            // Add the header for this label type.
            const labelTypeHeader = document.createElement('h3');
            ...
            const carouselId = `carousel-example-${labelType}`;
            ...
            for (const [labelIndex, label] of data[labelType].entries()) {
                ...
                const gsvImage = document.createElement('img');
                ...
                const validatorComment = document.createElement('div');
            ...
            const leftControlIcon = document.createElement('span');
            ...
            const leftControlScreenReading = document.createElement('span');
            ...
            const rightControlIcon = document.createElement('span');
            ...
            const rightControlScreenReading = document.createElement('span');
