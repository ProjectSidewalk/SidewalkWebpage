 ...
 *
 * Generates a preview of PS label tags grouped by label type by fetching data directly from the Label Tags API.
 *
    ...
    renderLabelTags(data, container) {
      ...
      sortedLabelTypes.forEach((labelType) => {
        ...
        tagsForType.sort((a, b) => a.tag.localeCompare(b.tag)).forEach((tag) => {
          ...
          // The family directory stays literal so tools/lint/check-asset-paths.mjs can tell the digest manifest covers it.
