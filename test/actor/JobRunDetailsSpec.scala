  ...
  "the run details of a job with both a nightly and a hand trigger" should {
    ...
    "record crop generation's every count, and the rule that cut the store" in {
      CropRunResult(
        ...
        dimsMismatch = 25, dimsUnverified = 26, downscaledWritten = 27, downscaledDeleted = 28, provenanceExplore = 30,
        provenanceWindow = 31, provenanceUnresolved = 32, errors = 29
        ...
        "provenance_explore"    -> 30,
        "provenance_window"     -> 31,
        "provenance_unresolved" -> 32,
        "errors"                -> 29
      )
    }
