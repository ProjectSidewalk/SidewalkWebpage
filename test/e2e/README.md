...
| `about-stats-band.spec.js` | `/about`'s stats band across viewport widths, with worst-case values swapped in: no stat's value or caption collides with its neighbour (#5151) |
