...
const A11Y_ALLOWLIST = {
  ...
  '/api': [],
  '/v3/api-docs': [],
  '/v3/api-docs/labelTypes': [],
  '/v3/api-docs/cities': [],
  '/v3/api-docs/labelTags': [],
  '/v3/api-docs/rawLabels': [],
  '/v3/api-docs/labelClusters': [],
  '/v3/api-docs/streets': [],
  '/v3/api-docs/streetTypes': [],
  '/v3/api-docs/regions': [],
  '/v3/api-docs/accessScoreStreets': [],
  '/v3/api-docs/accessScoreRegions': [],
  '/v3/api-docs/validations': [],
  '/v3/api-docs/validation-result-types': [],
  '/v3/api-docs/labelEdits': [],
  '/v3/api-docs/user-stats': [],
  '/v3/api-docs/overall-stats': [],
  '/v3/api-docs/overall-stats-by-day': [],
  '/v3/api-docs/aggregate-stats': [],
  '/v3/api-docs/aggregate-stats-by-day': [],
  '/gallery': [],
