...
landing.partners.official.contact = Project Sidewalk is een onderzoekstool. Neem voor het melden van een probleem of het aanvragen van een reparatie rechtstreeks contact op met {0}. Je kunt links naar labels of verhalen van Project Sidewalk aan je verzoek toevoegen.
...
dashboard.team.error.name.comma = De teamnaam mag geen komma bevatten.
dashboard.team.error.name.numeric = De teamnaam mag niet alleen uit cijfers bestaan.
dashboard.team.error.name.taken = Die naam is al in gebruik door een ander team.
