...
dashboard.mistakes.intro.weakest = Jouw labels die anderen als onjuist hebben gevalideerd, zodat je je blik kunt aanscherpen. Je nauwkeurigheid verschilt per labeltype — je lastigste type (van de typen met minstens {0} gevalideerde labels) is gemarkeerd.
