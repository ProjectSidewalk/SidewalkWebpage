...
routebuilder.reverse.street.instruction = Klik op een straat in je route en kies "Richting omkeren" om de looprichting te wisselen.
routebuilder.delete.street.icon.alt = Een prullenbak met een X erop
routebuilder.delete.street.instruction = Klik op een straat in je route en kies "Straat verwijderen" om hem te verwijderen.
...
routebuilder.share.warning = Geen account? Kopieer deze link zodat je je route later terugvindt. We onthouden je recente routes ook op dit apparaat.
...
routebuilder.saved.to.account = Deze route is opgeslagen in je account.
routebuilder.view.in.dashboard = Bekijk hem in je dashboard
routebuilder.recent.routes = Je recente routes
...
routebuilder.legend.title = Kaartlegenda
routebuilder.legend.start = Waar je route begint
routebuilder.legend.end = Waar je route eindigt
routebuilder.legend.gap = Gelijke nummers markeren een onderbreking: het ene deel van je route eindigt en het volgende begint
routebuilder.legend.direction = Pijlen tonen de looprichting
routebuilder.directions.title = Of plan een route op adres
routebuilder.directions.start = Start
routebuilder.directions.end = Einde
routebuilder.directions.hint = Typ adressen of versleep de spelden — we stellen een wandelroute voor die je nog straat voor straat kunt aanpassen.
