...
dashboard.mistakes.intro = Labels die anderen als onjuist hebben gevalideerd, zodat je je blik kunt aanscherpen. Je nauwkeurigheid verschilt per labeltype.
dashboard.mistakes.intro.weakest = Labels die anderen als onjuist hebben gevalideerd, zodat je je blik kunt aanscherpen. Je nauwkeurigheid verschilt per labeltype — je lastigste type is gemarkeerd.
