...
other = Otro
curb.ramp.description = Rampa peatonal que conecta la banqueta con la calle
missing.ramp.description = Falta una rampa peatonal
obstacle.description = Obstáculo en el camino
surface.problem.description = Problema con la superficie de la banqueta
no.sidewalk.description = No hay banqueta en este lado de la calle
crosswalk.description = Cruce peatonal marcado
signal.description = Semáforo o botón peatonal que ayuda a cruzar la calle
occlusion.description = Vista obstruida
other.description = Otro problema de accesibilidad
low = Bajo
medium = Medio
high = Alto
...
landing.partners.creator.uw.alt = Logotipo de la Paul G. Allen School of Computer Science & Engineering de la Universidad de Washington
...
dashboard.hero.headline = Has colocado <strong>{0} etiquetas</strong> en {1}, haciendo las banquetas más accesibles.
...
dashboard.kpi.scope = Tus totales en {0}.
dashboard.map.caption = Dónde has explorado en {0}: tus calles auditadas y etiquetas. Abre la leyenda para filtrar.
dashboard.cities.title = Ciudades que has mapeado
dashboard.cities.map.caption = Cada ciudad de Project Sidewalk que has mapeado. Un círculo más grande significa más etiquetas colocadas ahí.
dashboard.streak.title = Tu racha
dashboard.streak.intro = Mantén tu impulso: cada día que mapeas, validas o exploras en {0} cuenta.
...
dashboard.standing.intro = Un vistazo a tu lugar en {0} esta semana. La tabla completa está <a href="{1}">en la tabla de clasificación</a>.
...
dashboard.mistakes.intro = Tus etiquetas en {0} que otras personas validaron como incorrectas, para que afines tu ojo. Tu precisión varía según el tipo de etiqueta.
dashboard.mistakes.intro.weakest = Tus etiquetas en {0} que otras personas validaron como incorrectas, para que afines tu ojo. Tu precisión varía según el tipo de etiqueta; el que más te cuesta está resaltado.
...
dashboard.team.leave = Salir del equipo
...
dashboard.settings.team.help = Únete a un equipo o clase para mapear en conjunto y aparecer en la tabla de equipos.
...
dashboard.profile.headline = {0} ha colocado <strong>{1} etiquetas</strong> en {2}, haciendo las banquetas más accesibles.
