...
routebuilder.reverse.street.instruction = Haz clic en una calle de tu ruta y elige "Invertir dirección" para cambiar el sentido del recorrido.
routebuilder.delete.street.icon.alt = Un bote de basura con una x
routebuilder.delete.street.instruction = Haz clic en una calle de tu ruta y elige "Quitar calle" para eliminarla.
...
routebuilder.share.warning = ¿Sin cuenta? Copia este enlace para poder encontrar tu ruta de nuevo. También recordaremos tus rutas recientes en este dispositivo.
...
routebuilder.saved.to.account = Esta ruta está guardada en tu cuenta.
routebuilder.view.in.dashboard = Verla en tu panel
routebuilder.recent.routes = Tus rutas recientes
...
routebuilder.legend.title = Leyenda del mapa
routebuilder.legend.start = Donde comienza tu ruta
routebuilder.legend.end = Donde termina tu ruta
routebuilder.legend.gap = Los números iguales marcan un hueco: una parte de tu ruta termina y la siguiente comienza
routebuilder.legend.direction = Las flechas muestran la dirección del recorrido
routebuilder.directions.title = O planifica una ruta por dirección
routebuilder.directions.start = Inicio
routebuilder.directions.end = Fin
routebuilder.directions.hint = Escribe direcciones o arrastra los marcadores: sugerimos una ruta a pie que aún puedes editar calle por calle.
