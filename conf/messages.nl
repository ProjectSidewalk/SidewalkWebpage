...
landing.ml.gif.mLabels = machine-etiketten
landing.ml.gif.you = jij
landing.ml.gif.uLabels = gebruikerslabels
landing.ml.gif.bcp = betere stadsplanning
landing.ml.gif.btt = betere temporele tracking
landing.ml.gif.ivt = interactieve visualisatietools
landing.ml.gif.sr = slimmere routering
landing.ml.gif.ml = machine learning
