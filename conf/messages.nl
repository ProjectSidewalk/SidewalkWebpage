...
landing.stats.content.partiallyopen = Gebruikers zoals jij hebben al {0} kilometer van {1} in kaart gebracht, {2}—dat is {3}% van het doelgebied in de stad!
...
landing.stats.percentopen = van doelgebied in kaart gebracht
