# --- !Ups
DELETE FROM webpage_activity LEFT JOIN sidewalk_user ON webpage_activity.user_id = sidewalk_user.user_id WHERE webpage_activity.user_id IS NULL OR sidewalk_user.user_id IS NULL;
