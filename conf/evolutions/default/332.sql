...
-- IF NOT EXISTS guards re-application across city schemas that may already have the value.
ALTER TYPE ui_source ADD VALUE IF NOT EXISTS 'LandingPage' BEFORE 'Old data, unknown source';
...
CREATE TYPE ui_source AS ENUM (
    ...
    'ExternalTagValidationASSETS2024', 'Old data, unknown source', 'SharedLabel', 'SharedLabelImage',
    'SharedLabelThumbs'
);
