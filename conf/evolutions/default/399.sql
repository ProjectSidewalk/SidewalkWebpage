# --- !Ups
-- Government places (town halls, courthouses, government offices) join the place catalog, for the Explore minimap's
-- landmarks and the AccessScore map. PlaceCategory (Scala) is the catalog, and PlaceTableSpec holds it to this CHECK.
