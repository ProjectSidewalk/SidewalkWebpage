...
landing.ml.gif.mLabels = etiquetas automatizadas
landing.ml.gif.you = tú
landing.ml.gif.uLabels = etiquetas de usuarias
landing.ml.gif.bcp = mejor planificación urbana
landing.ml.gif.btt = mejor seguimiento temporal
landing.ml.gif.ivt = herramientas de visualización interactiva
landing.ml.gif.sr = enrutamiento inteligente
landing.ml.gif.ml = aprendizaje de máquinas
