...
landing.stats.content.partiallyopen = Personas usuarias como tú ya han mapeado {0} kilómetros de {1}, {2}—¡eso es el {3}% del área objetivo en la ciudad!
...
landing.stats.percentopen = del área objetivo mapeada
