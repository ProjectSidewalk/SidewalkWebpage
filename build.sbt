...
//  "org.geotools" % "gt-geojson" % "24.0",
  ...
  //  "org.playframework" %% "anorm" % "2.3.10", // https://mvnrepository.com/artifact/com.typesafe.play/anorm / https://www.playframework.com/documentation/2.4.x/Migration24#Anorm
