...
libraryDependencies ++= Seq(
  ...
  "org.geotools" % "gt-shapefile" % "35.0" exclude ("javax.media", "jai_core"),
  "org.geotools" % "gt-epsg-hsql" % "35.0" exclude ("javax.media", "jai_core"),
  "org.geotools" % "gt-geopkg"    % "35.0" exclude ("javax.media", "jai_core"),
