...
#     bash tools/dev/worktree-remove.sh <name> [--force] [--container <web-container>]
#
# Runs on the HOST, unlike tools/dev/qa-worktree.sh: a worktree's .git file points at the main repo's .git/worktrees/<name>
...
stop_qa_session() {
  ...
  docker exec "$CONTAINER" bash -c \
    "script=/home/.claude/worktrees/$WT/tools/dev/qa-worktree.sh; \
