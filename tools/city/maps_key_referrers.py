...
no panos. `make onboard-city` offers to run this in step 2; standalone:
    ...
    python3 tools/city/maps_key_referrers.py newport-ky            # add the city's two hostnames
    python3 tools/city/maps_key_referrers.py newport-ky --dry-run  # show what would be added, change nothing
    python3 tools/city/maps_key_referrers.py --check               # list every city missing from the key
