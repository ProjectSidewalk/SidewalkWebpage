# GSV FOV probe results — 2026-09-03T18:15:50.768Z

Run: `2026-09-01T18-31-57-133Z` · Maps channel requested: `quarterly` · resolved `google.maps.version`: `3.65.12f` · estimator `295422a5a946`

## Verdict: **width-pinned-vfov-clamped**

vFov clamp window: ceiling null° (0 binding cells), floor 14.974° (8 binding cells)

Gates: method=PASS, model=PASS, anisotropy=PASS (5 of 8 pitch cells excluded as unreliable), seed=PASS (median |seedF−f|/f = 0.01448)
