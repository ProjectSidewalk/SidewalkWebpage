-- Patched mainline 196.sql (issue #4700), generated by gen-patches.sh: keep DC's config row by its
-- database_name ('sidewalk') rather than by current_database(), which the migrated schema never matches.
CREATE TABLE config (
...
DELETE FROM config WHERE database_name <> 'sidewalk';
