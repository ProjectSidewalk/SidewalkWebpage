...
CREATE EXTENSION IF NOT EXISTS postgis WITH SCHEMA sidewalk;
...
CREATE EXTENSION IF NOT EXISTS pgrouting WITH SCHEMA sidewalk;
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (8, 'ffb62e3b6ff1969d24d110264c653423358d1fc4', '2018-12-23 00:00:00', 'INSERT INTO role (role_id, role) VALUES (5, ''Owner'');
INSERT INTO user_role (user_id, role_id) VALUES
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (9, '2d8b53ec4bf3a308253dea9fbd549f1774de290e', '2018-12-23 00:00:00', 'INSERT INTO street_edge_assignment_count (street_edge_id) VALUES ( 27047 );
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (10, '3665d53cca49c0c89f9925ac831fcdbdb1c51820', '2018-12-23 00:00:00', 'ALTER TABLE mission_user
ADD pay_per_mile REAL NOT NULL DEFAULT 0.0;', 'ALTER TABLE mission_user
DROP pay_per_mile;', 'applied', '');
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (11, '8bc3e0323734fe001794f029abfdd9ae95df6d0a', '2018-12-23 00:00:00', 'UPDATE street_edge SET deleted = TRUE WHERE street_edge_id IN (
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (12, 'bf0c3c7ca359bc9d9d02e32740d77d4848dcbda9', '2018-12-23 00:00:00', 'CREATE TABLE street_edge_priority
(
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (20, '55ab87806c6225a0299f72d9c0a14408a3cabfc5', '2018-12-23 00:00:00', 'CREATE TABLE version
(
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (13, '9b90fbe01031639e37efb5c1ab8a8bd80634bb9d', '2018-12-23 00:00:00', 'DROP TABLE sidewalk_edge_accessibility_feature;
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (14, '681faf9f4d33ee8fc8a4282ff504b3a2f8946834', '2018-12-23 00:00:00', 'CREATE TABLE tag
(
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (15, '053ee8053696bf242f3328d46ab0b6ac037bfb8e', '2018-12-23 00:00:00', 'UPDATE role SET role = ''Registered'' WHERE role = ''User'';
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (16, '8ba76a53808779f9345fd40edcd5ce5cb77b325b', '2018-12-23 00:00:00', 'DROP TABLE mission_user;
DROP TABLE mission;
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (17, 'a2c12a7c7e8c8edc9c333ddefa40a6025103f0aa', '2018-12-23 00:00:00', 'ALTER TABLE problem_description RENAME COLUMN problem_description_id TO label_description_id;
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (18, '260e919c6be702266f1a0e421e92e0c863ce200c', '2018-12-23 00:00:00', 'DROP TABLE street_edge_assignment_count;', 'CREATE TABLE street_edge_assignment_count
(
...
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (19, '489553004b15fb0b1d7e5d07983dd0cef5e2b606', '2018-12-23 00:00:00', 'ALTER TABLE "user" RENAME TO sidewalk_user;', 'ALTER TABLE sidewalk_user RENAME TO "user";', 'applied', '');
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (21, '3af579236282e92c1988b602c652167a2402b130', '2018-12-23 00:00:00', 'INSERT INTO version VALUES (''5.0.0'', now(), ''Overhaul mission infrastructure and anonymous user ids.'');', 'DELETE FROM version WHERE version_id = ''5.0.0'';', 'applied', '');
INSERT INTO sidewalk.play_evolutions (id, hash, applied_at, apply_script, revert_script, state, last_problem) VALUES (22, 'bcba55c26c6e5c47a0f7a01f8f0ee38c89657f9f', '2018-12-23 00:00:00', 'ALTER TABLE label ADD COLUMN tutorial BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE TABLE sidewalk.region (
    ...
    description character varying(2044) COLLATE pg_catalog."POSIX" NOT NULL,
    geom sidewalk.geometry(Geometry,4326),
    deleted boolean DEFAULT false NOT NULL
);
...
CREATE TABLE sidewalk.sidewalk_edge (
    geom sidewalk.geometry(LineString,4326),
    y1 double precision,
    x2 double precision,
    x1 double precision,
...
CREATE TABLE sidewalk.street_edge (
    street_edge_id integer NOT NULL,
    geom sidewalk.geometry(LineString,4326) NOT NULL,
...
CREATE TABLE sidewalk.street_node (
    ...
    geom sidewalk.geometry(Point,4326) NOT NULL,
    lat double precision NOT NULL,
    lng double precision NOT NULL
);
