...
function Onboarding_CannotFindBusStop (params) {
    var oPublic = {
        className : 'Onboarding_CannotFindBusStop'
    };
    ...
    oPublic.panoId = '7txC6LCTjT6kW4d-lCgCnA';
    ...
    function InstructTurkerToLookAtTheMap () {
        ...
        myTracker.push('OnboardingCannotFindBusStop_InstructTurkerToLookAtTheMap');
    ...
    function AdjustHeadingAngle () {
        ...
        var mouseDown = false;
        myTracker.push('OnboardingCannotFindBusStop_AdjustHeadingAngle');
    ...
    function SuggestTheBusStopIsMissing () {
        myTracker.push('OnboardingCannotFindBusStop_SuggestTheBusStopIsMissing');
    ...
    function InstructToReportAbsenceOfBusStop () {
        myTracker.push('OnboardingCannotFindBusStop_InstructToReportAbsenceOfBusStop');
    ...
    function InstructToClickICannotFindAnyBusStopRadioButton () {
        myTracker.push('OnboardingCannotFindBusStop_InstructToClickICannotFindAnyBusStopRadioButton');
    ...
    function SubmitAndComplete () {
        myTracker.push('OnboardingCannotFindBusStop_SubmitAndComplete');
        // Submit!
        ...
        $("#BusStopAbsence_Submit").on('click', function (){
            ...
            myTracker.push('OnboardingCannotFindBusStopSubmit');
    ...
    oPublic.start = function () {
        ...
        myTracker.push('OnboardingCannotFindBusStopStart');
