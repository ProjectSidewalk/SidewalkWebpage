...
# Once the task is succesfully completely the external server needs to perform a POST operation to an mturk url (not included here)
external_question = '<ExternalQuestion xmlns="http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2006-07-14/ExternalQuestion.xsd"><ExternalURL>'+url+'</ExternalURL><FrameHeight>500</FrameHeight></ExternalQuestion>'
